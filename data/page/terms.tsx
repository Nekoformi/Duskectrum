export const page_en = (
    <>
        ...
        <section>
            <p>
                This Terms of Use (hereinafter referred to as "these <b>TERMS</b>") sets forth the terms and conditions for the use of all text, code, media, software, and support or services (hereinafter referred to as "the <b>DATA</b>, etc.") provided by Sara Kotova, Nekoformi and at_0111 (hereinafter referred to as "<b>WE</b>" or "<b>US</b>"). By complying with these <b>TERMS</b>, you (hereinafter referred to as "the <b>USER</b>") are permitted to download, use, reproduce, modify, display, and advertise (hereinafter referred to as "<b>USE</b>") the <b>DATA</b>, etc.
            </p>
        </section>
        ...
        <section>
            ...
            <ol>
                <li>
                    These <b>TERMS</b> shall apply to all relationships between the <b>USER</b> and <b>US</b> regarding the <b>USE</b> of the <b>DATA</b>, etc.
                </li>
                <li>
        ...
        <section>
            ...
            <ol>
                ...
                <li>
                    <b>WE</b> shall not bear any responsibility or provide any guarantees for damages arising from the <b>DATA</b>, etc. (except in cases of intentional or gross negligence on my part).
                </li>
                <li>
                    <b>WE</b> shall not bear any responsibility or provide any guarantees regarding transactions, communications, disputes, etc. that may arise between <b>USER</b> and other <b>USER</b> or third parties in relation to the <b>DATA</b>, etc.
                </li>
                <li>
                    If you intend to <b>USE</b> the <b>DATA</b>, etc. for commercial purposes (whether directly or indirectly), please inquire with <b>US</b> to obtain approval, and follow any instructions provided by <b>US</b>.
                </li>
                <li>
        ...
        <section>
            ...
            <ol>
                <li>
                    Downloading, using, and reproducing the <b>DATA</b>, etc. without notifying or informing <b>US</b>
                </li>
                <li>
                    Appropriately displaying and advertising the <b>DATA</b>, etc. without notifying or informing <b>US</b>
                </li>
                <li>
        ...
        <section>
            ...
            <ol>
                ...
                <li>
                    Any other acts deemed inappropriate by <b>US</b>
                </li>
            </ol>
        </section>
        ...
        <section>
            ...
            <ol>
                <li>
                    If the <b>USER</b> <b>USE</b> the <b>DATA</b>, etc. in a manner that violates these <b>TERMS</b>, <b>WE</b> may take legal action.
                </li>
            </ol>
        </section>
...
export const page_ja = (
    <>
        ...
        <section>
            <p>
                この利用規約（以下「<b>本規約</b>」と表記）は、Sara Kotova、Nekoformi、at_0111の3名（以下「<b>私たち</b>」と表記）が提供する全ての文章、コード、メディア、ソフトウェア、及びサポートやサービス（以下「<b>データ等</b>」と表記）の利用条件・使用条件を定めるものです。皆様（以下「<b>ユーザー</b>」と表記）には、<b>本規約</b>に従うことで<b>データ等</b>のダウンロード、使用、複製、改変、表示、宣伝（以下「<b>利用</b>」と表記）が可能となります。
            </p>
        </section>
        ...
        <section>
            ...
            <ol>
                <li>
                    <b>本規約</b>は、<b>ユーザー</b>と<b>私たち</b>との間の<b>データ等</b>の<b>利用</b>に関わる一切の関係に適用されるものとします。
                </li>
                <li>
        ...
        <section>
            ...
            <ol>
                ...
                <li>
                    <b>データ等</b>によって発生した損害（<b>私たち</b>の故意又は重過失による場合を除く）について、<b>私たち</b>は如何なる責任・保障を負いません。
                </li>
                <li>
                    <b>データ等</b>に関して、<b>ユーザー</b>と他の<b>ユーザー</b>または第三者との間に於いて生じた取引、連絡、紛争などについて、<b>私たち</b>は如何なる責任・保障を負いません。
                </li>
                <li>
                    <b>データ等</b>を商業的に<b>利用</b>をする（直接的な<b>利用</b>・間接的な<b>利用</b>を問わず）場合は、<b>私たち</b>に問い合わせることで承諾を受けるか、<b>私たち</b>からの指示がある場合はそれに従ってください。
                </li>
                <li>
                    <b>ユーザー</b>によるクレーム等について、<b>私たち</b>の対応・反応に対する執拗な追求を禁じます。
                </li>
            </ol>
        </section>
        ...
        <section>
            ...
            <ol>
                <li>
                    <b>データ等</b>を<b>私たち</b>に連絡・告知することなくダウンロード、使用、複製する行為
                </li>
                <li>
                    <b>データ等</b>を<b>私たち</b>に連絡・告知することなく適切に表示、宣伝する行為
                </li>
                <li>
        ...
        <section>
            ...
            <ol>
                <li>
                    <b>ユーザー</b>が<b>データ等</b>を<b>本規約</b>に違反した形式で<b>利用</b>している場合、<b>私たち</b>が法的な措置を執行する場合があります。
                </li>
            </ol>
        </section>
        ...
        <section>
            ...
            <ol>
                <li>
                    <b>ユーザー</b>は<b>私たち</b>の書面・連絡による事前の承諾なく、<b>本規約</b>に基く権利もしくは義務を第三者に譲渡すること、または担保に供することはできません。
                </li>
            </ol>
        </section>
